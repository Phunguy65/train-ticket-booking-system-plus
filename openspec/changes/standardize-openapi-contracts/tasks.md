...
- [ ] 3.3 Annotate shared web payload records and enums such as `FailData`,
...
- [ ] 4.1 Generate and validate the backend OpenAPI document against
...
- [ ] 4.2 Mirror the generated customer contract to
      `shared/api-contracts/openapi.yaml` and remove outdated handwritten
      mismatches.
- [ ] 4.3 Add or update the heyapi generation workflow for the fetch-based
