...
class SeatTest {
    ...
    void create_shouldSetAllFieldsCorrectly() {
        Seat seat = Seat.create(SEAT_ID, COACH_ID, SEAT_NUMBER);

        assertThat(seat.getId()).isEqualTo(SEAT_ID);
        assertThat(seat.getCoachId()).isEqualTo(COACH_ID);
    ...
    void reconstitute_shouldRestoreAllFields() {
        ...
        Seat seat = Seat.reconstitute(SEAT_ID, COACH_ID, SEAT_NUMBER, createdAt, null);
