...
class ListUsersUseCaseTest {
    ...
    void execute_hasNext_propagatedToDto() {
        ...
        PageResult<UserDto> result = listUsersUseCase.execute(0, 5, "email", SortDirection.ASC);
    ...
    void execute_userDto_doesNotContainPasswordHash() {
        ...
        // UserDto record does not have a passwordHash field – compile-time guarantee.
        // This test asserts the email is present and the dto is well-formed.
        UserDto dto = result.items().get(0);
