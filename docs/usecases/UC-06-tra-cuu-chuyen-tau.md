...
| Bảo mật               | Kiểm tra xác thực bắt buộc trên cả 3 endpoint, không lộ thông tin nhạy cảm trong response, SQL injection test | 401 khi thiếu token; response chỉ chứa fields công khai; parameterized query chống injection                                                                                                                                                                       | Kiểm tra cả cursor decode không bị injection         |
...
| Xác thực người dùng                 | Chỉ khách hàng đã đăng nhập mới tra cứu được                                                         | Spring Security filter chain xử lý trước khi vào Controller                                                    | Test 401 khi thiếu/sai token trên cả 3 endpoint                                                                     |
